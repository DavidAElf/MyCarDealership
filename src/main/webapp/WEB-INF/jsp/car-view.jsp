...
<body>
	...
	<main>
		...
		<h1 class="cover-heading">Detail Page</h1>
									...
									<section class="py-5 text-center container">
										<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
											<div class="col-lg-6 col-md-8 mx-auto">
												<h1 class="fw-light">${car.carMake}/${car.carModel}</h1>
												<p class="lead text-muted">We are home to the most
													beautiful, the most fabulous, the... least appealing cars
													you can find on market. We hope you love our selection of
													ugly cars.</p>
											</div>
										</div>
									</section>
